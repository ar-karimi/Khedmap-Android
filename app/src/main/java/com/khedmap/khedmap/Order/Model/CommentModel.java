...
public class CommentModel implements CommentContract.ModelCallBack {
    ...
    @Override
    public void sendCommentRequest(Context context, final String requestBody,
                                   Response.Listener responseListener, Response.ErrorListener errorListener, String requestUrl) {


        RequestQueue queue = Volley.newRequestQueue(context.getApplicationContext());

        String URL = UtilitiesSingleton.getInstance().getBaseURL() + requestUrl;
