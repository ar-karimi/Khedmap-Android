...
public class EditFavoriteLocationModel implements EditFavoriteLocationContract.ModelCallBack {
    ...
    @Override
    public void sendFavoriteLocationDetailRequest(Context context, final String requestBody, Response.Listener responseListener, Response.ErrorListener errorListener) {


        RequestQueue queue = Volley.newRequestQueue(context.getApplicationContext());

        String URL = UtilitiesSingleton.getInstance().getBaseURL() + "favoriteLocation/detail";
    ...
    @Override
    public void sendEditFavoriteLocationRequest(Context context, final String requestBody, Response.Listener responseListener, Response.ErrorListener errorListener) {


        RequestQueue queue = Volley.newRequestQueue(context.getApplicationContext());

        String URL = UtilitiesSingleton.getInstance().getBaseURL() + "favoriteLocation/update";
