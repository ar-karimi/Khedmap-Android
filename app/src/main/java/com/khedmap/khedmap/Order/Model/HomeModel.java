...
public class HomeModel implements HomeContract.ModelCallBack {
    ...
    @Override
    public void sendGetCategoryItemsRequest(Context context, final String requestBody, Response.Listener responseListener, Response.ErrorListener errorListener) {
    ...
    @Override
    public void sendGetMiddleCategoryItemsRequest(Context context, final String requestBody, Response.Listener responseListener, Response.ErrorListener errorListener) {
    ...
    @Override
    public boolean getGuideTourShowedSharedPref(Context context) {

        //to make sharedPrefManager object
        if (sharedPrefManager == null)
            sharedPrefManager = new SharedPrefManager(context);

        return sharedPrefManager.getGuideTourShowed();
    }

    @Override
    public void setGuideTourShowedSharedPref(Context context) {

        //to make sharedPrefManager object
        if (sharedPrefManager == null)
            sharedPrefManager = new SharedPrefManager(context);

        sharedPrefManager.saveGuideTourShowed();
    }
