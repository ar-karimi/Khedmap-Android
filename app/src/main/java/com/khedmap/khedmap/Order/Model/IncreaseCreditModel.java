...
public class IncreaseCreditModel  implements IncreaseCreditContract.ModelCallBack {
    ...
    @Override
    public void sendGetCreditRequest(Context context, final String requestBody, Response.Listener responseListener, Response.ErrorListener errorListener) {
