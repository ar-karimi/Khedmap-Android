...
public class OrderSpecificationModel  implements OrderSpecificationContract.ModelCallBack {
    ...
    @Override
    public void sendGetSpecificationRequest(Context context, final String requestBody, Response.Listener responseListener, Response.ErrorListener errorListener) {


        RequestQueue queue = Volley.newRequestQueue(context.getApplicationContext());

        String FETCH_CATEGORIES_URL = UtilitiesSingleton.getInstance().getBaseURL() + "fetchSpecification";
