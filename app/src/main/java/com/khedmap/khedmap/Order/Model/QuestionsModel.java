...
public class QuestionsModel  implements QuestionsContract.ModelCallBack {
    ...
    @Override
    public void sendGetQuestionsRequest(Context context, final String requestBody, Response.Listener responseListener, Response.ErrorListener errorListener) {


        RequestQueue queue = Volley.newRequestQueue(context.getApplicationContext());

        String FETCH_CATEGORIES_URL = UtilitiesSingleton.getInstance().getBaseURL() + "fetchSubCategoryProperties";
