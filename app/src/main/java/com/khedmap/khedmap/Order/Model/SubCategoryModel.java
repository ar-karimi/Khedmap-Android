...
public class SubCategoryModel  implements SubCategoryContract.ModelCallBack {
    ...
    @Override
    public void sendGetSubCategoryItemsRequest(Context context, final String requestBody, Response.Listener responseListener, Response.ErrorListener errorListener) {


        RequestQueue queue = Volley.newRequestQueue(context.getApplicationContext());

        String FETCH_CATEGORIES_URL = UtilitiesSingleton.getInstance().getBaseURL() + "fetchSubCategories";
