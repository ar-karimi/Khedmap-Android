...
public class SuggestionDetailModel  implements SuggestionDetailContract.ModelCallBack {
    ...
    @Override
    public void sendGetSuggestionDetailItemsRequest(Context context, final String requestBody, Response.Listener responseListener, Response.ErrorListener errorListener) {


        RequestQueue queue = Volley.newRequestQueue(context.getApplicationContext());

        String URL = UtilitiesSingleton.getInstance().getBaseURL() + "orderRequest/detail";
