...
public class HangingStatePresenter implements HangingStateContract.PresenterCallBack {

    private HangingStateContract.ViewCallBack view;
    private HangingStateModel model;
    ...
    public HangingStatePresenter(HangingStateContract.ViewCallBack view, HangingStateModel model) {
        this.model = model;
        this.view = view;
    }
    ...
    @Override
    public void selectExpertButtonClicked(Context context) {
        ...
        context.startActivity(new Intent(context, WaitingForSuggestionsActivity.class).putExtra("submittedOrderId", submittedOrderId));
