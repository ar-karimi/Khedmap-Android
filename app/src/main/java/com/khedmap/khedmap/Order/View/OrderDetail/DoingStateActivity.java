...
public class DoingStateActivity extends AppCompatActivity implements DoingStateContract.ViewCallBack {


    @Inject
    DoingStateContract.PresenterCallBack presenterCallBack;
...
//to change font
        ...
        setContentView(R.layout.activity_doing_state);
...
//init dynamic part of detail page
        ...
        findViewById(R.id.call_expert_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                presenterCallBack.callExpertButtonClicked(DoingStateActivity.this);
            }
        });
    ...
    public void showSnackBar(String message) {
        ...
        new CustomSnackbar(message, DoingStateActivity.this, findViewById(R.id.coordinator_layout)).snackbar.show();
