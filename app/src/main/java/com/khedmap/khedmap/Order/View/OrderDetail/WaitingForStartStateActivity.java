...
public class WaitingForStartStateActivity extends AppCompatActivity implements WaitingForStartStateContract.ViewCallBack {


    @Inject
    WaitingForStartStateContract.PresenterCallBack presenterCallBack;
...
//to change font
        ...
        setContentView(R.layout.activity_waiting_for_start_state);
...
//init dynamic part of detail page
        ...
        findViewById(R.id.call_expert_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                presenterCallBack.callExpertButtonClicked(WaitingForStartStateActivity.this);
            }
        });
        ...
        findViewById(R.id.cancel_order_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                presenterCallBack.cancelOrderButtonClicked(WaitingForStartStateActivity.this);
            }
        });
    ...
    public void showSnackBar(String message) {
        ...
        new CustomSnackbar(message, WaitingForStartStateActivity.this, findViewById(R.id.coordinator_layout)).snackbar.show();
...
//to generate disproofsRecyclerView
        RecyclerView disproofsRecyclerView = new RecyclerView(WaitingForStartStateActivity.this);
...
//till here
        ...
        DisproofListAdapter.OnItemClickListener listener = new DisproofListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Disproof item) {
                ...
                presenterCallBack.disproofItemSelected(item, WaitingForStartStateActivity.this);
                alertDialog.dismiss();
            }
        };
    ...
    public void showConfirmationDialog() {
        ...
        alertDialog.setPositiveButtonClickListener(new OnClickListener.OnPositiveButtonClickListener() {
            ...
            public void onClick(View v) {
                ...
                presenterCallBack.rejectOrderClicked(WaitingForStartStateActivity.this);
