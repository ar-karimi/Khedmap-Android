...
import com.khedmap.khedmap.Order.Adapters.SubCategoryListAdapter;
import com.khedmap.khedmap.Order.Adapters.SubCategorySliderAdapter;
...
public class SubCategoryActivity extends AppCompatActivity implements SubCategoryContract.ViewCallBack {


    @Inject
    SubCategoryContract.PresenterCallBack presenterCallBack;
    ...
    private SubCategorySliderAdapter subCategorySliderAdapter;
...
////////////////////////////////////////////////////////////////////
        ...
        //to get selected item id and name from prev page
        presenterCallBack.setSelectedItemInfo(getIntent().getStringExtra("itemId")
...
//Search Icon
        findViewById(R.id.ic_search).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(SubCategoryActivity.this, SearchActivity.class), transitionAnimation);
            }
        });
        ...
        pullToRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                //Refresh Slider and SubCategoriesRecyclerView
                presenterCallBack.initSliderAndSubCategories(SubCategoryActivity.this);
        ...
        //init Slider and SubCategoriesRecyclerView
        presenterCallBack.initSliderAndSubCategories(this);
    ...
    public void initSlider() {
        ...
        subCategorySliderAdapter = new SubCategorySliderAdapter();

        List<String> slidesUrl = new ArrayList<>();
        slidesUrl.add("placeHolder");

        subCategorySliderAdapter.setSlides(slidesUrl);
        slider.setAdapter(subCategorySliderAdapter);
    }
        ...
        if (slides != null) {
            ...
            slider.setOnSlideClickListener(new OnSlideClickListener() {
                ...
                public void onSlideClick(int position) {
                    ...
                    presenterCallBack.slideItemClicked(slides.get(position), SubCategoryActivity.this);
                }
            });
        } else {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.navigation_menu_order_management:
                        startActivity(new Intent(SubCategoryActivity.this, OrdersManagementActivity.class));
                        drawerLayout.closeDrawers();
                        break;
                    case R.id.navigation_menu_increase_credit:
                        startActivity(new Intent(SubCategoryActivity.this, IncreaseCreditActivity.class));
                        drawerLayout.closeDrawers();
                        break;
                    case R.id.navigation_menu_favorite_locations:
                        startActivity(new Intent(SubCategoryActivity.this, FavoriteLocationActivity.class));
                        drawerLayout.closeDrawers();
                        break;
                    case R.id.navigation_menu_favorite_experts:
                        startActivity(new Intent(SubCategoryActivity.this, FavoriteExpertActivity.class));
                        drawerLayout.closeDrawers();
                        break;
                    ...
                    case R.id.navigation_menu_support:
                        presenterCallBack.callToSupportButtonClicked(SubCategoryActivity.this);
                        drawerLayout.closeDrawers();
                        break;
    ...
    @Override
    public void showSubCategoriesRecyclerView(List<SubCategory> subCategories) {

        RecyclerView recyclerView = findViewById(R.id.recycler_view_sub_categories);
        SubCategoryListAdapter.OnItemClickListener listener = new SubCategoryListAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(SubCategory item) {

                presenterCallBack.subCategoryItemClicked(item, false, SubCategoryActivity.this);
            }
        };
        ...
        recyclerView.setAdapter(new SubCategoryListAdapter(this, subCategories, listener));
    }
    ...
    public void showSnackBar(String message) {
        ...
        new CustomSnackbar(message, SubCategoryActivity.this, findViewById(R.id.coordinator_layout)).snackbar.show();
    ...
    public void showLogoutDialog() {
        ...
        alertDialog.setPositiveButtonClickListener(new OnClickListener.OnPositiveButtonClickListener() {
            ...
            public void onClick(View v) {
                ...
                presenterCallBack.logOutButtonClicked(SubCategoryActivity.this);
            }
        });
